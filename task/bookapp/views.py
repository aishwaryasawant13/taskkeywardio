...
def home(request):
 ...
 return render(request, 'bookapp/home.html', {'posts':posts})
...
#   ct = cache.get('count', version=user.pk)
  return render(request, 'bookapp/dashboard.html', {'posts':posts, 'full_name':full_name, 'groups':gps})
 else:
...
def user_signup(request):
 if request.method == "POST":
  ...
  if form.is_valid():
   messages.success(request, 'Congratulations!! successfully signed up.')
   user = form.save()
